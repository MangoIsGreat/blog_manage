  ...
  <div class="blog-container">
    <el-card class="head-card">
      <el-form :inline="true" :model="formInline" class="demo-form-inline">
        ...
        <el-form-item class="btn-form-item">
          <el-button size="small" type="primary" @click="getNewsList"
            >搜索</el-button
          >
    ...
    <el-card class="body-card">
      <el-table height="420" :data="tableData" style="width: 100%">
        <el-table-column width="120" prop="id" label="资讯ID">
        </el-table-column>
        <el-table-column width="120" prop="title" label="资讯名">
        </el-table-column>
        <el-table-column width="120" prop="User.id" label="作者ID">
        </el-table-column>
        <el-table-column width="120" prop="User.nickname" label="作者名">
        </el-table-column>
        <el-table-column width="120" prop="NewsType.tagName" label="类型">
        </el-table-column>
        <el-table-column width="120" prop="newsLikeNum" label="点赞数">
        </el-table-column>
        <el-table-column width="120" prop="newsReadNum" label="阅读数">
        </el-table-column>
        <el-table-column
          width="160"
        ...
        <el-table-column width="140" fixed="right" label="操作">
          <template slot-scope="scope">
            <el-button
              @click="$router.push(`/home/news/${scope.row.id}`)"
              type="text"
              >编辑</el-button
            >
...
export default {
  ...
  methods: {
    ...
    removeItem(item) {
      this.$confirm(`您确定要删除资讯 ${item.title} 吗？`, "友情提示", {
